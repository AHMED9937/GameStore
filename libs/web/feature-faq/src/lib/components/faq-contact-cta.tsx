...
export function FaqContactCta() {
  return (
    <section className={styles.ctaSection}>
      <Container>
        <div className="support-cta" aria-labelledby="faq-contact-heading">
          <div className="support-cta-body">
            ...
            <div className="support-cta-text">
              <Heading level="h3" id="faq-contact-heading">
                Do you have other questions?
              </Heading>
              <Text tone="muted" className={styles.ctaDescription}>
                Contact us by email or join our active community on Discord to
                discuss, share, and get faster assistance!
              </Text>
            </div>
          </div>
          <div className={styles.ctaActions}>
            <Link href="/contact" className={styles.faqSecondaryLink}>
              Contact Us
            </Link>
            <a
